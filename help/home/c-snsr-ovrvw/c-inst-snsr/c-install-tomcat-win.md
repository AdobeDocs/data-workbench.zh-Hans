---
description: 在Windows Server 2000或更高版本下运行的Apache Jakarta Tomcat 4.1或更高版本中安装和配置传感器的详细说明。
title: Windows Server 2000 或更高版本上的 Tomcat 服务器
...
# Windows Server 2000 或更高版本上的 Tomcat 服务器{#tomcat-server-on-windows-server-or-later}

{{eol}}

在Windows Server 2000或更高版本下运行的Apache Jakarta Tomcat 4.1或更高版本中安装和配置传感器的详细说明。
...
## 修改 Java 库路径 {#section-0dae181ef8884f10a57f6cfda8500969}
...
1. 在bin文件夹下，运行Tomcat9w.exe（常用守护程序服务管理器）。
   ...
   其中 [!DNL C:\Sensor] 目录是包含 [!DNL visual_sciences.dll] 文件。
