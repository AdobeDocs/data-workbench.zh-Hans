---
description: 有关安装和配置Microsoft Windows Server 2000或更高版本下运行的WebLogic Server 6.x或更高版本传感器的详细说明。
title: Windows Server 2000或更高版本上的WebLogic Server
...
# Windows Server 2000或更高版本上的WebLogic Server{#weblogic-server-on-windows-server-or-later}

有关安装和配置Microsoft Windows Server 2000或更高版本下运行的WebLogic Server 6.x或更高版本传感器的详细说明。
...
在用于启动WebLogic的脚本(例如，C:\bea\user_projects\mydomain\startServer.cmd)中，编辑“设置JAVA_OPTIONS=”行，将java.library.path定义设置为包含visual_sciences.dll文件的目录。
