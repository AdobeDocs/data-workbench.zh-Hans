...
|--- |--- |--- |
| 兩種參與層級 — **Expert與Ultimate** — 確保每位客戶都能獲得所需等級的支援、專業知識和指引。 | 有了專家支援計畫，您可以存取 **全年無休的專家服務** 以取得關鍵業務問題的技術疑難排解和指引。 或者，您可以通过我们的自助资源、独家最佳实践以及 Adobe 专家和同行的网络社区找到快速解决方案。*包含在所有 Adobe Experience Cloud 许可证中。* | 透過Ultimate Support計畫，您將體驗 **高接觸支援，提供個人化、主動的專家服務和指導**. 您的Adobe應用程式將由專家團隊進行安全一致的監控，這些專家熟悉您的環境，並專注於您的業務目標和解決方案健康狀況。 |
...
| **主動的技術與營運支援** | ![未包含圖示](assets/Cross_red_circle.svg){width="20"} 未包含 | <ul><li>藍圖審查、服務交付計畫 </li><li>維護與監控</li><li> 升級和移轉評論</li><li>發行準備與審查 </li></ul>知識轉移、解決方案疑難排解 <ul><li> 活動策劃（有限，請參閱活動管理附加元件）</li><li> 上市諮詢</li></ul> |
