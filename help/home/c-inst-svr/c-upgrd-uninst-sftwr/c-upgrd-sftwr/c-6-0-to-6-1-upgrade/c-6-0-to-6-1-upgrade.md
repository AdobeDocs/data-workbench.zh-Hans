...
1. 使用 **[!UICONTROL Software and Docs]** 配置文件，打开 **[!UICONTROL Start Here]** 工作区，并将所有需要的服务器包下载到本地文件夹。
   ...
   * 下载 **[!UICONTROL Server Packages]** \ **[!UICONTROL v6.1]** zip文件夹并解压所有文件。
      ...
      服务器包包括 **[!UICONTROL Lookup]** 和 **[!UICONTROL Profile]** 文件夹 **[!UICONTROL Base]** 和 **[!UICONTROL Transform]** 用于更新服务器的配置文件。
...
>[!IMPORTANT]
>
>升级到之前 **[!UICONTROL Client v6.1]**，管理员必须先升级到 **[!UICONTROL Insight Server v6.1.]**
...
1. 连接到您的配置文件。
   ...
   >[!NOTE]
   >
   >的 [!DNL Insight.zbin] 文件 [!DNL install] 文件夹是用于本地化的备份文件，必须存在。 此文件或其他 [!DNL .zbin] 将根据启动时传递的命令行设置来使用文件。

   请参阅 [设置本地化语言](../../../../../home/c-inst-svr/c-upgrd-uninst-sftwr/c-upgrd-sftwr/c-6-0-to-6-1-upgrade/c-localized-ime.md#concept-86d7602cd6ec416b8d4a518f325e001e) 添加 [!DNL insight.zbin] 文件。
...
1. 启动您创建的用于同步用户档案和已更新用户档案的快捷方式 [!DNL .zbin] 文件。
