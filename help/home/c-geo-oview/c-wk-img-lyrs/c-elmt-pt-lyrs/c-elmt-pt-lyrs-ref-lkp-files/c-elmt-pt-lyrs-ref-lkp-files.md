...
您可以使用 [!DNL Dynamic Points] 功能，用于将位置的纬度和经度嵌入到维度每个元素的名称中。 请参阅 [定义使用动态点的元素点层](../../../../../home/c-geo-oview/c-wk-img-lyrs/c-elmt-pt-lyrs/c-elmt-pt-lyrs-ref-lkp-files/c-elmt-pt-lyr-file-frmt/c-dyn-pts.md#concept-77ae65bedc3f465489bc135ae7e3c2f3).
