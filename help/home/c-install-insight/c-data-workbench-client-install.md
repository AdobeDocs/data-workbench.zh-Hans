...
* **安装 Adobe[!DNL Acrobat]以将缩放的工作区打印成 PDF。** 要将缩放的工作区打印为Adobe PDF格式，安装Data Workbench的计算机必须安装Adobe，然后才能将其打 [!DNL Acrobat] 印出来。
...
* **实施安全措施。** 对于Data Workbench计算机，您应遵循公司的常规企业安全策略。 为了实现其主要用途，Data Workbench只需要能够连接到服务器（通过端口80和443）以及任何收集数据的服务器。 只要您维护Data Workbench软件并为Data Workbench分配至少10 GB的存储空间，您就可以将Data Workbench硬件用于任何其他用途。
