...
如果需要帮助来确定实验的最小长度，可以使用由Adobe提供的实验设计电子表格作为帮助设计实验的工具。 默认情况下，此文件名为[!DNL VS Controlled Experiment Design.xls]，不仅可用作工作表，还可用作您对实验所作决策的记录。 有关此文件的更多信息，请参阅[实验设计电子表格](../../../home/c-undst-ctrld-exp/t-exp-dsn-spst.md#task-d7f674980fe9415d80371d6020bcf164)。
